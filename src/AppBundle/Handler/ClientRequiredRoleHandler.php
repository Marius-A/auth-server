...
class ClientRequiredRoleHandler implements HandlerInterface
{
    const HANDLER_NAME = 'client_required_role.handler';
    ...
    public function clientAll($clientId, $limit, $offset)
    {
        ...
        $qb->select('r');
        $qb->innerJoin('r.requiredClients', 'c');
    ...
    public function put(array $parameters, Context $context)
    {
        ...
        $this->clientService->applyRequiredRoleOnClient($client, $role);
    ...
    public function delete(array $parameters, Context $context)
    {
        ...
        $this->server->deleteClientTokenCacheIndex($client);
        $this->clientService->deleteRequiredRoleOnClient($client, $role);
